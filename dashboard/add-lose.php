                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="post" class="text-right">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="username" class="form-control form-control-user" placeholder="مثال: جوال ايفون7 , بطاقة صرافة... ">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class=" form-control form-input" placeholder="أكتب التفاصيل هنا..." cols="50" rows="10" autocomplete="off"></textarea>
                                    </div>
