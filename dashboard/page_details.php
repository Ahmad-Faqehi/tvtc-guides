                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <p class="fonty-par text-right p-2">
                                    يتم إنشاء التصميم لمثال البطاقة الأساسية هذا باستخدام فئات الأداة المساعدة Bootstrap الافتراضية. باستخدام فئات الأدوات المساعدة ، يمكن تعديل نمط مكون البطاقة بسهولة دون الحاجة إلى أي CSS مخصص
                                </p>

                                <hr class="sidebar-divider my-0">
                                <div class="p-1 text-right">
                                    <div class="font-weight-bold Fonty pb-2 pt-1 "> اسم المرسل: <span class="font-weight-normal"> ساره علي</span> </div>
                                    <div class="font-weight-bold Fonty pb-2 ">  رقم الاكاديمي: <span class="font-weight-normal">102546</span> </div>
                                    <div class="font-weight-bold Fonty pb-2 ">  إئميل المرسل: <span class="font-weight-normal"><a href="mailto:info@tvtc.edu.sa">info@tvtc.edu.sa</a></span> </div>
                                </div>
